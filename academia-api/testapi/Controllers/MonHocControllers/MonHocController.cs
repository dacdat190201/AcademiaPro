...
namespace testapi.Controllers
{
    ...
    public class MonHocController : Controller
    {
        ...
        public async Task<IActionResult> GetMonhocAllGV(int maChuDe, int? pageNumber, int? pageSize)
        {
            var data = await _monhocService.GetMonhocAllGV(maChuDe,pageNumber, pageSize);
            if (data == null)
                return NotFound();
            return Ok(data);
        }
        //[HttpGet]
        //public async Task<IActionResult> GetMonhocAllGV()
        //{
        //    var data = await _monhocService.GetMonhocAllGV();
        //    if (data == null)
        //        return NotFound();
        //    return Ok(data);
        //    //tra ve DL thoi
